...
myDataDir <- file.path(home, "Data", "TBPInputs", "mut_gene")
...
write.table(all.dt, file.path("~/Code/tissue_biomarker/MutationByGeneMasterToRunList.txt"), quote = FALSE, row.names = FALSE, sep = ",", col.names = FALSE)
